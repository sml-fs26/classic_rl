/* Click-step scene engine for the Spooky House Bellman-recursion viz.

   7 scenes (0..6), 0-indexed throughout (hash, array, builders).
...
(function () {
  const SCENES = [
    { key: 'scene0', title: 'Many states, one value each' },
    { key: 'scene1', title: 'Pick a path' },
    { key: 'scene2', title: 'Greedy needs the future' },
    { key: 'scene3', title: 'The backward sweep' },
    { key: 'scene4', title: 'Reading the policy' },
    { key: 'scene5', title: 'Adding γ' },
  ...
  window.SpookyViz = { goTo, getCurrentScene: () => current, sceneTitles: SCENE_TITLES };
})();
