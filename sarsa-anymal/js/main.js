/* Click-step scene engine for the SARSA-on-ANYmal capstone viz.

   6 scenes, 0-indexed throughout. Pattern lifted from anymal-mdp/js/main.js.
...
(function () {
  const SCENES = [
    { key: 'scene0', title: 'Putting it together' },
    { key: 'scene1', title: 'The SARSA update' },
    { key: 'scene2', title: 'One step' },
    { key: 'scene3', title: 'Episodes accumulate' },
    { key: 'scene4', title: 'The policy emerges' },
  ...
  window.SARSAViz = { goTo, getCurrentScene: () => current, sceneTitles: SCENE_TITLES };
})();
