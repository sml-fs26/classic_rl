...
(function () {
  const SCENES = [
    ...
    { key: 'sceneMdpStates',      title: 'S — the state set',         music: 'concept' },
    { key: 'sceneMdpActions',     title: 'A — the action set',        music: 'concept' },
    { key: 'sceneMdpTransitions', title: 'P — transitions',           music: 'concept' },
    { key: 'sceneMdpRewards',     title: 'R — the reward signal',     music: 'concept' },
    { key: 'sceneMdpGamma',       title: 'γ — the discount factor',   music: 'concept' },
