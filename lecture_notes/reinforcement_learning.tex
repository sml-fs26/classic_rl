...
\section{The \texorpdfstring{$Q$}{Q}-function and the Bellman equation}
...
\begin{tcolorbox}[colback=inknavy!4!white,colframe=inknavy!80!black,boxrule=0.6pt,arc=2pt,
                  left=8pt,right=8pt,top=2pt,bottom=6pt,title={The Bellman equation},
                  fonttitle=\bfseries\small]
\begin{equation}\label{eq:bellman}
Q^\star(s_i, a_i) \;=\; \E\bigl[\, r_i + \gamma\, Q^\star(s_{i+1}, a_{i+1}) \,\bigr].
\end{equation}
\end{tcolorbox}
\noindent
...
$Q$-function and the Bellman equation. The fastest way to make all of this concrete is to
