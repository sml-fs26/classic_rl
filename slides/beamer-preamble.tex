...
% Computer Modern Bright, a light sans from the Computer Modern family whose
% MATH is also sans, so formulas and text share one voice. (Chosen over
% Latin Modern Sans, LM Roman, Helvetica, and Source Sans in a font audition.)
%
...
\usepackage{cmbright}              % Computer Modern Bright: light sans, with matching sans math
\usefonttheme{professionalfonts}  % let cmbright own the math, do not let beamer override it
