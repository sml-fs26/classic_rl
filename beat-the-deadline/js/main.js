/* Click-step scene engine for Beat the Deadline.
 *
...
(function () {
  ...
  const BADGE_STORE_KEY = 'btd-badges';
  ...
  function init() {
    ...
    document.addEventListener('click', (e) => {
      const t = e.target;
      if (t && t.classList && (t.classList.contains('btd-btn') || t.classList.contains('poke-btn') || t.classList.contains('lever-chip')) && !t.disabled) cursorBlip();
    });
