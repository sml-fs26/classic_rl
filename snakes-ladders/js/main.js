/* Click-step scene engine for the Snakes & Ladders integrative review.

   6 scenes, 0-indexed. Lifted from sarsa-anymal/js/main.js.
...
(function () {
  const SCENES = [
    { key: 'scene0', title: 'A children’s game is an MDP' },
    { key: 'scene1', title: 'Roll a die' },
    { key: 'scene2', title: 'Bellman, but for cycles' },
    { key: 'scene3', title: 'γ as risk preference' },
    { key: 'scene4', title: 'SARSA learns it from scratch' },
    { key: 'scene5', title: 'All five pieces in one game' },
  ];
  ...
  window.SLViz = { goTo, getCurrentScene: () => current, sceneTitles: SCENE_TITLES };
})();
