...
(function () {
  ...
  window.I18N.register({
    ...
    jp: {
      'scene4.title': 'ポリシー',
      'scene4.lede':  'ポリシー π は あなたの ひょうじゅん さぎょう てじゅん： <em>すべての</em> じょうきょうで レバーを なづける ルール。 プレイした とき あなたは すでに ポリシー だった。 かいて いなかった だけ。',
      'scene4.formulaLabel': 'ポリシーは すべての じょうきょうを レバーに うつす',
      'scene4.presetLabel': '2つの ほんものの ほぜん ドクトリン (と ミックス) を ためす：',
      'scene4.presetA': 'こしょうまで うんてん',
      'scene4.presetB': 'つねに ざいこ',
      'scene4.presetC': 'よわったら こうかん',
      'scene4.blurbA': '<b>こしょうまで うんてん。</b> ぜんぶの セルが うんてん。 やすくて かんたん、 でも からの ビンで こしょうすると ラインが とまり -8。 かいぎで よく べんごされる ドクトリン。',
      'scene4.blurbB': '<b>つねに ざいこ。</b> けんこうどに かかわらず ビンが いっぱいに なるまで はっちゅう。 さいだいの ほご、 でも よびひん 1こ ごとに まいターン -1、 そして ほごを けっして つかわない。',
      'scene4.blurbC': '<b>よわったら こうかん。</b> けんこうなら うんてん、 ろうきゅうしたら すぐ こうかん (よびひん あれば)。 よさそう、 でも さいぜん？ からの ビンの セルは どうする？',
      'scene4.note': 'ドクトリン ぜんたいが 2D ヒートマップで ひとめ。 どれも あきらかに さいぜん では ない。 それが これからの たんさく。',
      'scene4.framing': 'これらは ほんものの しんらいせい チームが べんごする ドクトリン。 グリッドで SOP ぜんたいを いちどに <em>みて</em>、 くらべられる。 つぎは じょうきょう ごとに どの レバーが ほんとうに さいぜんかを とう。',
    },
  });
})();
