...
(function () {
  ...
  window.I18N.register({
    en: {
      ...
      'scene2.lede':   'You are the growth PM for one trial. Start a cold user on day 5, pull a lever each day, and feel the randomness bite.',
      'scene2.tier':   'tier',
      'scene2.day':    'day',
      'scene2.payoff': 'payoff',
      'scene2.pick':   'Pick a lever for this day:',
      'scene2.restart':'NEW TRIAL',
      'scene2.tapeTitle': 'this trial, day by day',
    ...
    jp: {
      ...
      'scene2.lede':   'あなたは 1つの トライアルの グロース PM。 つめたい ユーザーを 5にちめから はじめ、 まいにち レバーを ひき、 ランダムさを かんじよう。',
      'scene2.tier':   'レベル',
      'scene2.day':    'にち',
      'scene2.payoff': 'ペイオフ',
      'scene2.pick':   'この ひの レバーを えらぶ：',
      'scene2.restart':'あたらしい トライアル',
      'scene2.tapeTitle': 'この トライアル、 ひごとに',
