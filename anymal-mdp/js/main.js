/* Click-step scene engine for the ANYmal MDP first-contact viz.

   6 scenes, 0-indexed throughout (hash, array, builders).
...
(function () {
  const SCENES = [
    { key: 'scene0', title: 'An MDP is five things' },
    { key: 'scene1', title: 'The state' },
    { key: 'scene2', title: 'The action' },
    { key: 'scene3', title: 'Stochasticity' },
    { key: 'scene4', title: 'The reward' },
  ...
  window.MDPViz = { goTo, getCurrentScene: () => current, sceneTitles: SCENE_TITLES };
})();
