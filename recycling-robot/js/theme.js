/* Theme toggle. Two modes: light (cream NES paper, the lecture default) and
   crt (a screen-only high-contrast amber-phosphor variant, matching the
...
(function () {
  const STORAGE_KEY = 'recycling-robot.theme';
