...
(function () {
  window.I18N.register({
    en: {
      ...
      'scene12.sub': 'Six ideas, one ticket shelf. The bones of revenue management, and of reinforcement learning.',
      'scene12.close': 'You have learned the bones of revenue management, and of reinforcement learning. A ticket shelf today, any sequential decision under uncertainty tomorrow.',
      'scene12.footnote': 'A seat, a room, a slot, a fleet of fares: same situation, lever, draw, and payoff. The shelf was just the place to learn to read them.',
      ...
      'scene12.card.mdp.blurb': 'Four parts: the SITUATION (units left times days left), the LEVER you pull (a price tag), the part you do not control (the demand draw), and the PAYOFF (price times units sold). An empty shelf at midnight pays nothing.',
      ...
      'scene12.card.return.blurb': 'The return is every dollar collected from now until midnight, not just today’s sale. Played from the same shelf, the same lever can return very different amounts; its spread is the risk you carry into the deadline.',
      ...
      'scene12.tag.return': 'summed to midnight, with risk',
    ...
    jp: {
      ...
      'scene12.sub': '六つの かんがえ、ひとつの たな。 レベニューマネジメントと 強化学習の きほん。',
      'scene12.close': 'レベニューマネジメントと 強化学習の きほんを まなびました。 今日は チケットの たな、明日は 不確かさのなかの あらゆる じゅんじ けってい。',
      'scene12.footnote': '座席、部屋、枠、運賃の むれ。 おなじ じょうきょう・レバー・ぬきとり・はらい。 たなは それを よむ ための れんしゅうの ばだった。',
      'scene12.replay': 'タイトルへ もどる',

      'scene12.card.mdp.title': 'MDP の わくぐみ',
      'scene12.card.mdp.blurb': '四つの ぶぶん: じょうきょう（のこり × しめきりまで）、ひく レバー（ねふだ）、せいぎょできない ぶぶん（じゅよう ぬきとり）、はらい（ねだん × うれた すう）。 まよなかの からの たなは 何も はらわない。',
      ...
      'scene12.card.return.title': 'しめきりまでの はらいの ごうけい',
      'scene12.card.return.blurb': 'リターンは いまから まよなかまでに あつめた すべての お金。 今日の うりあげ だけでは ない。 おなじ たなから ひいても、おなじ レバーが まったく ちがう がくを かえす。 そのちらばりが しめきりへ はこぶ リスク。',
