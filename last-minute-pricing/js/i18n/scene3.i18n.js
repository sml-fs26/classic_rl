...
(function () {
  window.I18N.register({
    en: {
      ...
      'scene3.s3.formalP':
        '<b>P(s′, r | s, a)</b>: pull lever <b>a</b> in situation <b>s</b>, draw demand, sell what you can. Time ticks down one day; seats drop by what sold.',
      'scene3.s3.formalR':
      ...
      'scene3.s4.kR':        'payoff',
      'scene3.s4.gamma':
        'No discount here (gamma = 1): departure is only four days out, so we just add the cash up. The clock does the work a discount usually would.',
    ...
    jp: {
      ...
      'scene3.s1.manager':
        'ざせきが どれだけ あり、じかんが どれだけ すくないか。きょう きめるのに ひつような すべてです。すぎたことは かんけい ありません。',
      'scene3.s1.formal':
        '<b>s = (u, d)</b>：ざせき <b>u</b> は 1..5、しゅっぱつまでの にっすう <b>d</b> は 1..4。ばんは すべての じょうきょうを いちどに ＝ 5x4 の 20マス。',
      'scene3.s1.foot':      'フライトカードが じょうたい そのもの：ひだりに ざせき、みぎに とけい。',
      ...
      'scene3.s3.formalP':
        '<b>P(s′, r | s, a)</b>：じょうきょう <b>s</b> で レバー <b>a</b> を ひき、じゅようを ひき、うれるだけ うる。じかんは １にち へり、ざせきは うれたぶん へる。',
      'scene3.s3.formalR':
      ...
      'scene3.s4.kR':        'みかえり',
      'scene3.s4.gamma':
        'ここでは わりびき なし (gamma = 1)：しゅっぱつは ４にちさきだけ なので、げんきんを たすだけ。とけいが わりびきの やくめを はたします。',
      ...
      'notes.scene3':
        ...
        '<li><b>じょうたい</b> = フライトカード (u, d)。<i>マルコフせい</i>を きょうちょう：きょうの さいぜんしゅは きょうの じょうきょうだけで きまり、けいろは いらない。</li>' +
        '<li><b>こうどう</b> = ３つの レバー、１にち １つ。</li>' +
        '<li><b>せんい＋みかえり</b>を まとめる：じゅようの ひきが うごかし、かつ はらう。かくりつが みえるのが ようてんで、のちの DPに つながる。</li>' +
        '<li>みかえり = ねだん x うれた ざせき、しゅっぱつの のこりは $0。$0 で ひとこきゅう、レベニュー マネジメントの きんちょう その もの。</li>' +
