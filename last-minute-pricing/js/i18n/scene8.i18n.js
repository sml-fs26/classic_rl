...
(function () {
  window.I18N.register({
    en: {
      ...
      'scene8.backup.lead':
        'One day before departure at <b>2 seats, 2 days</b>, the backup under ' +
      ...
      'scene8.backup.tie':
        'The weighted leaf sum is <b>{eg}</b> = Q*({u}s / {d}d, {lever}) &mdash; ' +
      ...
      'scene8.read.r':     '<b>R</b> &mdash; the cash the lever pays you <i>today</i> (price &times; seats sold).',
      ...
      'scene8.worked.subtitle':'{u} seats left, {d} day to departure',
      'scene8.worked.lastday':
        'On the <b>last day</b> every tomorrow is gate-close, worth <b>$0</b>. ' +
      ...
      'scene8.calc.future0': 'future = $0 (gate closed)',

      /* verdict line under the calc */
      'scene8.verdict.best':  'On the last day with a full-ish cabin, <b>{lever}</b> wins: you cannot move seats at a premium, so dump them before GATE CLOSED.',
    ...
    jp: {
      ...
      'scene8.read.r':     '<b>R</b>：レバーが <i>きょう</i> はらう げんきん（かかく &times; うれた ざせきすう）。',
      ...
      'scene8.worked.subtitle':'のこり {u}せき・しゅっぱつまで {d}にち',
      'scene8.worked.lastday':
        '<b>さいしゅうび</b> は あした すべてが ゲートクローズ（<b>$0</b>）です。' +
      ...
      'scene8.calc.term': '{p} &middot; じゅよう {k} &rarr; {sold}せき うる &rarr; {price}&times;{sold} = {rev}',
      'scene8.calc.termCapped': '{p} &middot; じゅよう {k} &rarr; {sold}せき うる（{u}で うちどめ）&rarr; {price}&times;{sold} = {rev}',
      'scene8.calc.sumLabel': 'Q*(s, {lever}) = E[ R ]',
      'scene8.calc.total': '= {total}',
      'scene8.calc.future0': 'みらい = $0（ゲートクローズ）',

      'scene8.verdict.best':  'さいしゅうびに ざせき おおめ なら <b>{lever}</b> が かち：プレミアムでは さばけないので、ゲートが しまる まえに さばく。',
