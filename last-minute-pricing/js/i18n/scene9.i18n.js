...
(function () {
  window.I18N.register({
    en: {
      ...
      'scene9.ready.body':
        'Press STEP COLUMN to fill the departure-adjacent day first. Each cell takes the ' +
    ...
    jp: {
      ...
      'scene9.premise':
        ...
        'できる りゆう。ベルマン バックアップを、しゅっぱつから <b>うしろむき</b> に、にっすうの ' +
        'れつ ごとに すいそうする。',
      ...
      'scene9.ready.body':
        '「れつを すすめる」で しゅっぱつに いちばん ちかい ひ から うめる。みぎに とけた ' +
