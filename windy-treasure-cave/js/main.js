/* Click-step scene engine for Windy Treasure Cave.
 *
...
(function () {
  ...
  const BADGE_STORE_KEY = 'wtc-badges';
  ...
  function init() {
    ...
    document.addEventListener('click', (e) => {
      const t = e.target;
      if (t && t.classList && (t.classList.contains('wtc-btn') || t.classList.contains('poke-btn')) && !t.disabled) cursorBlip();
    });
